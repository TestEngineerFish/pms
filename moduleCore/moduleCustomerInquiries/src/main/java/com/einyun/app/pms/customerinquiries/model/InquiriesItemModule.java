...
public class InquiriesItemModule implements Serializable {
    ...
    public int getUnsatisfy_version() {
        return unsatisfy_version;
    }

    public void setUnsatisfy_version(int unsatisfy_version) {
        this.unsatisfy_version = unsatisfy_version;
    }
    ...
    public String getOrg_project_level() {
        return org_project_level;
    }

    public void setOrg_project_level(String org_project_level) {
        this.org_project_level = org_project_level;
    }
    ...
    public void setREF_ID_(int REF_ID_) {
