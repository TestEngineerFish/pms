...
public class InquiriesListModule {
    private int total;
    private int page;
    private int pageSize;
    private List<InquiriesItemModule> rows;
    ...
    public List<InquiriesItemModule> getRows() {
        return rows;
    }

    public void setRows(List<InquiriesItemModule> rows) {
        this.rows = rows;
    }
