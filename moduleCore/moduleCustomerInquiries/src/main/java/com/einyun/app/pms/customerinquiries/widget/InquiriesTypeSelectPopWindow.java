package com.einyun.app.pms.customerinquiries.widget;
...
public class InquiriesTypeSelectPopWindow extends PopupWindow {
    List<InquiriesTypesBean> mInquiriesTypesModule;
    private  View view;
    private Activity context;
    private OnItemClickListener mListener;
    private RVBindingAdapter<InquiriesPopwindowItemBinding, InquiriesTypesBean> adapter;//外部适配器
    private int mPosition=-1;

    public InquiriesTypeSelectPopWindow(Activity context, List<InquiriesTypesBean> mInquiriesTypesModule, int mPosition) {
        super(context);
        this.mInquiriesTypesModule=mInquiriesTypesModule;
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        view = inflater.inflate(R.layout.inquiriestype_popwindow, null);//alt+ctrl+f
...
//                }
        ...
        //一级列表适配器
        adapter = new RVBindingAdapter<InquiriesPopwindowItemBinding, InquiriesTypesBean>(context, com.einyun.app.pms.customerinquiries.BR.select) {

            @Override
            public void onBindItem(InquiriesPopwindowItemBinding binding, InquiriesTypesBean model, int position) {
