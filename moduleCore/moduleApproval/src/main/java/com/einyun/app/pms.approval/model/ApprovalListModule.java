...
public class ApprovalListModule {
    private int total;
    private int page;
    private int pageSize;
    private List<ApprovalItemmodule> rows;
    ...
    public List<ApprovalItemmodule> getRows() {
        return rows;
    }

    public void setRows(List<ApprovalItemmodule> rows) {
        this.rows = rows;
    }
