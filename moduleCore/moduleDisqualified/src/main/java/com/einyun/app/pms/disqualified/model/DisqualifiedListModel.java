...
public class DisqualifiedListModel {
    private int total;
    private int page;
    private int pageSize;
    private List<DisqualifiedItemModel> rows;
    ...
    public List<DisqualifiedItemModel> getRows() {
        return rows;
    }

    public void setRows(List<DisqualifiedItemModel> rows) {
        this.rows = rows;
    }
