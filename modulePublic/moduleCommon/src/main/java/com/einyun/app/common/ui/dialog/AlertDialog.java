...
public class AlertDialog {
    ...
    public AlertDialog builder() {
        ...
        txt_msgTwo = (TextView) view.findViewById(R.id.txt_msg_two);
        txt_msgTwo.setVisibility(View.GONE);
    ...
    public AlertDialog setMsgTwo(String msg) {
        showMsg = true;
        if ("".equals(msg)) {
            txt_msgTwo.setText("内容");
        } else {
            txt_msgTwo.setText(msg);
            txt_msgTwo.setVisibility(View.VISIBLE);
        }
        return this;
    }
