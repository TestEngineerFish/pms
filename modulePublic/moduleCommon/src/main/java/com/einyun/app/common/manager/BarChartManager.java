 ...
 * @Package: com.einyun.app.common.manager
 * @ClassName: BarChartManager
 * @Description: java类作用描述
 * @Author: chumingjun
 * @CreateDate: 2019/11/4 0004 上午 10:30
 * @UpdateUser: 更新者
 * @UpdateDate: 2019/11/4 0004 上午 10:30
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public class BarChartManager {
    ...
    private void initLineChart() {
        ...
        //设置图标边框的颜色
        mBarChart.setBorderColor(Color.parseColor("#FF55A3EE"));
...
//      不显示描述信息
        ...
        mBarChart.getXAxis().setLabelRotationAngle(0);
//         图例设置
...
//        // 线跟数据都不显示
     ...
     * 展示柱状图(一条)
     */
    public void showBarChart(List<BarEntry> yVals, String label, List<String> orgName, int color) {
        initLineChart();
...
//        文字的大小
        ...
        BarDataSetValueFormatter barDataSetValueFormatter = new BarDataSetValueFormatter();
        barDataSet.setValueFormatter(barDataSetValueFormatter);
...
//      设置宽度
        ...
        //设置X轴的刻度数
        String[] xValues = orgName.toArray(new String[orgName.size()]);
        String[] yValues = {"0%", "20%", "40%", "60%", "80%", "100%"};
        xAxis.setLabelCount(xValues.length + 1, true);//设置X轴的刻度数
        xAxis.setDrawLabels(true);//是否显示X轴刻度描述
...
//        leftAxis.setLabelCount(yValues.length + 1, false);
        leftAxis.setAxisLineColor(Color.parseColor("#999999"));
//        设置Y轴的最小值和最大值
    ...
    public class BarDataSetValueFormatter implements IValueFormatter {
...
//            Log.e("TAG", "xValues[(int) value]====="+xValues[(int) value]);
    ...
    public class XAxisValueFormatter implements IAxisValueFormatter {
        ...
        @Override
        public String getFormattedValue(float value, AxisBase axis) {
            Log.e("shmshmshm", "=====" + value);
            int x = (int) (value + 1);
            if(x < xValues.length) return xValues[x];
            else return "";
        }
    }
