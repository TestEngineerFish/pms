...
import com.einyun.app.common.databinding.ItemFilterViewBinding;
...
private ItemFilterViewBinding binding;
    ...
    public SMFilterView(Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(R.layout.item_filter_view, this, true);
        binding= DataBindingUtil.setContentView((Activity) context, R.layout.item_filter_view);

        binding.rlRightParent.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
            }
        });

        binding.rlLeftParent.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                //process reset back
                animationHide(true);
        ...
        binding.btnConfirm.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(binding.rvFilterContent.getContext(),
                3,
        ...
        binding.rvFilterContent.setLayoutManager(gridLayoutManager);
        binding.rvFilterContent.setAdapter(m_adapter);
    ...
    public void animationShowout(){
        ...
        binding.rlRightParent.startAnimation(hideAnim);

        AlphaAnimation alphaAnim = new AlphaAnimation(0, 1);
        alphaAnim.setDuration(300);
        binding.rlAlphaBackground.startAnimation(alphaAnim);
