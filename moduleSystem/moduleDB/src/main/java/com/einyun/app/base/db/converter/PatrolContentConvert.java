...
public class PatrolContentConvert {
    ...
    @TypeConverter
    public PatrolContent stringToSomeObjectList(String data) {
        if (data == null) {
            return null;
        }

        Type listType = new TypeToken<PatrolContent>() {}.getType();

        return gson.fromJson(data, listType);
    }

    @TypeConverter
    public String someObjectListToString(PatrolContent someObjects) {
