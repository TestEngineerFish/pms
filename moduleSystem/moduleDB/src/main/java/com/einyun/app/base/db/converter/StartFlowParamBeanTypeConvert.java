...
public class StartFlowParamBeanTypeConvert {
    ...
    @TypeConverter
    public CreateUnQualityRequest.StartFlowParamObjectBean stringToSomeObjectList(String data) {
        if (data == null) {
            return null;
        }

        Type listType = new TypeToken<CreateUnQualityRequest.StartFlowParamObjectBean>() {}.getType();

        return gson.fromJson(data, listType);
    }

    @TypeConverter
    public String someObjectListToString(CreateUnQualityRequest.StartFlowParamObjectBean someObjects) {
