...
public class BizDataBeanTypeConvert {
    ...
    @TypeConverter
    public CreateUnQualityRequest.BizDataBean stringToSomeObjectList(String data) {
        if (data == null) {
            return null;
        }

        Type listType = new TypeToken<CreateUnQualityRequest.BizDataBean>() {}.getType();

        return gson.fromJson(data, listType);
    }

    @TypeConverter
    public String someObjectListToString(CreateUnQualityRequest.BizDataBean someObjects) {
